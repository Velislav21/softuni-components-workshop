...
export default function TableRow({firstName, lastName, email, phoneNumber, createdAt }) {
    return (
        <tr>
            <td>
                <img
            ...
            <td>{email}</td>
            <td>{phoneNumber}</td>
            <td>{new Intl.DateTimeFormat("en-GB", { month: 'long', day: 'numeric', year: 'numeric' }).format(new Date(createdAt))}</td>
